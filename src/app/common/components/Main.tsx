...
import clonImage from "../../../../public/images/clon_mercadolibre.jpg";
import cupones from "../../../../public/images/otro.jpg";
import cocina from "../../../../public/images/main_cocina.jpg";
import tecnologia from "../../../../public/images/main_tecnologia.jpg";
import logistic from "../../../../public/images/main_logistic.png";
import mercado from "../../../../public/images/main_mercado.jpg";
import laptop from "../../../../public/images/main_laptops.jpg";
import ropa from "../../../../public/images/main_ropa.jpg";
import estetica from "../../../../public/images/main_estetica.jpg";
import "swiper/css";
      ...
      <div className="h-custom-height flex flex-col max-w-[1200px] min-w-full">
          ...
          <div className="flex flex-row items-center justify-center pt-5 pb-10 rounded-md ">
            <div className="h-[100px] w-[1200px] flex  justify-center bg-white  rounded-md ">
              <div className="flex justify-center items-center pr-10">
                <div className="mr-4">
                  <Image width={50} height={50} src={`https://http2.mlstatic.com/storage/homes-korriban/assets/images/payments/credit-card.svg`} alt="credit" />
                </div>
                <div className="flex flex-col">
                  <p className="text-lg">Hata 48 cuotas</p>
                  <Link className="text-blue-600" href={`https://www.google.com/`}>Ver más</Link>
                </div>
              </div>
              <div className="flex justify-center items-center pr-10">
                <div className="mr-4">
                  <Image width={50} height={50} src={`https://http2.mlstatic.com/storage/homes-korriban/assets/images/payments/transfer.svg`} alt="credit" />
                </div>
                <div className="flex flex-col">
            ...
            <div className="flex justify-center items-center pr-20 ">
                <div className="mr-4">
                  <Image width={50} height={50} src={`https://http2.mlstatic.com/storage/homes-korriban/assets/images/payments/payment-agreement.svg`} alt="credit" />
                </div>
                <div className="flex flex-col">
            ...
            <div className="flex justify-center items-center  pr-20">
                <div className="mr-4">
                  <Image width={50} height={50} src={`https://http2.mlstatic.com/storage/homes-korriban/assets/images/payments/view-more.svg`} alt="credit" />
                </div>
                <div className="flex flex-col">
        ...
        <section className="bg-gray-[300]">
          ...
          <div className="flex flex-row justify-between bg-gradient-to-r from-[#a90f90] via-[#a90f90] to-[#0c1a51] ... h-[85px] rounded-t-lg">
            <h1 className="flex pl-12 text-2xl items-center text-white font-bold">Suscríbete al nivel 6</h1>
          ...
          <h1 className="ml-10 text-lg mt-3">Consigue los mejores beneficios en Mercado Libre</h1>

          <div className="flex flex-row items-center justify-center pt-5 pb-10 rounded-md ">
            <div className="h-[100px] w-[1200px] flex  justify-center bg-white  rounded-md ">
              
                <div className="flex flex-row justify-center items-center mr-16">
                  <Image width={110} height={110} src={`https://http2.mlstatic.com/resources/frontend/statics/loyal/partners/widget-l6/dplus.svg`} alt="credit" />
                  <p className="text-sm ml-4">Disney+ sin cargo</p>
                </div>
                <div className="flex flex-row justify-center items-center mr-16">
                  <Image width={110} height={110} src={`https://http2.mlstatic.com/resources/frontend/statics/loyal/partners/widget-l6/starplus.svg`} alt="credit" />
                ...
                <div className="flex flex-row justify-center items-center w-[320px]">
                  ...
                  <p className="text-sm ml-4">Envíos gratis y rápidos desde $ 90.000 y 40% OFF en envíos de menos de $ 90.000</p>
                </div>
            </div>
            ...
            <div className="flex justify-end items-end mr-5">
              <button className="bg-blue-500 px-4 py-2 text-xs text-white font-semibold my-4 border rounded-lg">Suscríbete</button>
            ...
            <div className="h-[250px] w-[1200px] flex justify-center">
                ...
                <div className="flex flex-row bg-white ml-3 rounded-lg ">
                  <div className="flex flex-col justify-center items-start pr-4 ">
                   ...
                   <p className="text-2xl flex px-[40px]">SUPERMERCADO HASTA 25% OFF</p>
                   <button className="bg-blue-500 py-2 ml-5 text-xs text-white font-semibold my-4 border rounded-lg px-[50px] ">
                    Ver más
                   </button>

                  </div>
                  <Image className="rounded-r-lg" width={250} height={205} src={mercado} alt="mercado" />
                </div>
                <div className="flex flex-row bg-white ml-9 rounded-lg ">
                  <div className="flex flex-col justify-center items-start  ">
                   <p className="text-xs flex px-[10px]">ACTUALIZA TU EQUIPO</p>
                   <p className="text-2xl flex px-[10px]">COMPUTADORES Y CELULARES HASTA 20% OFF</p>
                   <button className="bg-blue-500 py-2 ml-5 text-xs text-white font-semibold my-4 border rounded-lg px-[50px]">
                    Ver más
                   </button>

                  </div>
                  <Image className="rounded-r-lg" width={250} height={205} src={laptop} alt="mercado" />
                </div>
            </div>
          </div>
